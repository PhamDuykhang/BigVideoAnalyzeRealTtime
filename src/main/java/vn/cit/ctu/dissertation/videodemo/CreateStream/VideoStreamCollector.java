...
import vn.cit.ctu.dissertation.videodemo.CreateStream.Utils.PropertyFileReader;
...
public class VideoStreamCollector {
	...
	private static void generateIoTEvent(KafkaProducer<String, String> producer, String topic, String camId, String videoUrl) throws Exception {
